...
* It's recommended extract the .csv files created by the author from each folder and save them in just one folder to use correctly the script written.
...
The first part of the script developed load the training and the testing data, creating the sets to train and test the neural network. 
